...
def create_pairs(train, string, length):
    ...
    '''
    if string == "Test":
        dfPos = pd.read_csv("/content/drive/MyDrive/MedIx REU/Datasets/Max Slices/TESTPosPairs.csv")
        dfNeg = pd.read_csv("/content/drive/MyDrive/MedIx REU/Datasets/Max Slices/TESTNegPairs.csv")
    
    else:
        dfPos = pd.read_csv("/content/drive/MyDrive/MedIx REU/Datasets/Max Slices/PosPairs.csv")
        dfNeg = pd.read_csv("/content/drive/MyDrive/MedIx REU/Datasets/Max Slices/NegPairs.csv")
...
#train data
path = "/content/drive/MyDrive/MedIx REU/TrainData/"
pickle_in = open(path + "TrainPairs22.pickle", "rb")
trainPixel = pickle.load(pickle_in)
trainPixel = np.asarray(trainPixel)
tr_pairs = trainPixel.reshape(20000,2,71,71,1)

#train labels
pickle_in = open(path + "TrainLabel2.pickle", "rb")
